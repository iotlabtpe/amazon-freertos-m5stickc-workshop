---
layout: post
title:  "Lab 3 - Just in Time Registeration with Greengrass"
categories: [lab]
tags: [setup]
...
# Lab3: Just in Time Registeration with Greengrass

## overview

In this lab you will:

1. Use openssl on Cloud9 to create your certs and import your CA to AWS IoT

2. Create a lambda function and IoT Action to provision Greengrass in AWS IoT

3. Install and start greengrass with the certs you've created in **step 1**

4. Verifiy in AWS IoT Console that the group is successfully created/provisioned and then deploy the greengrass group

# Use openssl on Cloud9 to create your certs and import your CA to AWS IoT

You will do the following on your **Cloud9**:
...
on Cloud9 terminal, use the following cmd to download the latest greengrass sdk
...
```
- If hardlinks and softlinks are set to 1, your protections are enabled correctly. if not, use following command to update it temporory.
...
- - you can find your endpoint(iotHost) here
...
```
1. use vim or your favirote editor to update the config.json on Cloud9 terminal
...
use the following cmd to move the certs into /greengrass/certs on your Cloud9 termnial
